                        ...
                        {{csrf_field()}}
                            <fieldset>
                            	...
                            	<div class="form-group">
                                    <input class="form-control @error('name') is-invalid @enderror" placeholder="Admin Name" name="name" type="name" required autocomplete="name">
                                ...
                                <div class="form-group">
                                    <input class="form-control @error('email') is-invalid @enderror" placeholder="E-mail" name="email" type="email" required autocomplete="email" >
                                ...
                                <div class="form-group">
                                    <input class="btn btn-success btn-block" name="btn" type="submit" value="Register">
                                </div>
                            </fieldset>
                        </form>
                    </div>
